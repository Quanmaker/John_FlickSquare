...
#define FS2_OAUTH_KEY    (@"UFAEMW3NROAVNQGAT3WLMQNIAYGVKF3G05WKDWZS0CXL515T")
#endif

#ifndef FS2_OAUTH_SECRET
#define FS2_OAUTH_SECRET (@"XCIBWYHMBNEKE42KSOUA5WFMSXTRRA5QY5BROEL1OYKDXQUZ")
#endif

//2, don't forget to added app url in your info plist file CFBundleURLTypes
#ifndef FS2_REDIRECT_URL
#define FS2_REDIRECT_URL @"app://flicksquare"
#endif

//3 update this date to use up-to-date Foursquare API
#ifndef FS2_API_VERSION
#define FS2_API_VERSION (@"20130528")
#endif
